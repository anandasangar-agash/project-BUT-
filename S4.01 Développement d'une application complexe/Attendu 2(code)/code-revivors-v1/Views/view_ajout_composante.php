...
<div class="add-container">
    <div class="form-abs">
        ...
        <form action="?controller=<?= $_GET['controller'] ?>&action=ajout_composante" method="post">
            ...
            <div class="form-address">
                ...
                <select name="type-voie" id="">
                    <option disabled selected value="0">Type de voie</option>
                    <?php foreach ($typeVoies as $typeVoie) { ?>
                        <option value="<?= $typeVoie['id_type_voie'] ?>"><?= $typeVoie['libelle'] ?></option>
                    <?php } ?>
                </select>
